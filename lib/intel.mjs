 ...
 */
export async function cycleIntel({ cycle, payouts, series, clips, includeMoney = true }) {
  ...
  const recap = payouts.totalViews > 0
    ? writeRecap({
        ...
        // Money-free recap for reach-only viewer codes.
        paidCents: includeMoney ? payouts.totalPayoutCents : 0,
